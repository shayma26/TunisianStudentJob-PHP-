...
<main id="main">
    ...
    if (isset($_POST['submit'])) {
        ...
        $email = $_SESSION['user'];
        $sql2 = "SELECT id_et FROM etudiant WHERE email_et='$email'";
        ...
        $sql = "SELECT id_an,poste,localisation,date_deb,date_fin,salaire,date_depot,email_contact,num_contact,image,type,competences,description,entreprise,nombre_vues FROM annonce WHERE id_an IN(SELECT id_an FROM favoris WHERE id_et='$id_et')";
    }
    if ($res = mysqli_query($conn, $sql)) {
        ...
        while ($row = mysqli_fetch_assoc($res)) {
            ...
            <button type="submit" class="btn btn-danger" name="delete_fav">Delete</button>
            </form>
